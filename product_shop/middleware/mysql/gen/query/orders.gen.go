...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.UserID = field.NewString(tableName, "userID")
	_order.ProductID = field.NewString(tableName, "productID")
	_order.OrderStatus = field.NewInt32(tableName, "orderStatus")
...
func (o *order) updateTableName(table string) *order {
	...
	o.OrderStatus = field.NewInt32(table, "orderStatus")
