...
func newProduct(db *gorm.DB, opts ...gen.DOOption) product {
	...
	_product.ProductNum = field.NewInt32(tableName, "productNum")
	_product.ProductImage = field.NewString(tableName, "productImage")
	_product.ProductURL = field.NewString(tableName, "productURL")
	_product.ProductGHURL = field.NewString(tableName, "productGHURL")
	_product.ProductInfo = field.NewString(tableName, "productInfo")
...
type product struct {
	...
	ProductNum   field.Int32
	ProductImage field.String
	ProductURL   field.String
	ProductGHURL field.String
	ProductInfo  field.String
...
func (p *product) updateTableName(table string) *product {
	...
	p.ProductNum = field.NewInt32(table, "productNum")
	p.ProductImage = field.NewString(table, "productImage")
	p.ProductURL = field.NewString(table, "productURL")
	p.ProductGHURL = field.NewString(table, "productGHURL")
	p.ProductInfo = field.NewString(table, "productInfo")
...
func (p *product) fillFieldMap() {
	...
	p.fieldMap["productNum"] = p.ProductNum
	p.fieldMap["productImage"] = p.ProductImage
	p.fieldMap["productURL"] = p.ProductURL
	p.fieldMap["productGHURL"] = p.ProductGHURL
	p.fieldMap["productInfo"] = p.ProductInfo
}
